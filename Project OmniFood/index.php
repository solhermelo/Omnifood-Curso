...
<html lang="en">
    ...
    <head>
        ...
        <meta name="description" content="Omifood is a premium food delivery service with the mission to bring affordable and healthy meals to as many people as possible.">
    ...
    <body>
        ...
        <section class="section-features js--section-features" id="features">
            ...
            <div class="row  js--wp-1">
                ...
                <div class="col span-1-of-4 box">
                        <ion-icon name="clock" class="icon-big"></ion-icon>                     
            ...
            <div class="row">
                ...
                <div class="col span-1-of-2 steps-box">
                    <div class="works-step">
                        <div >1</div>
                        <p>Choose the subscription plan that best fits your need and sign up today</p>
                    </div>
        ...
        <section class="section-cities" id="cities">
           <div class="row">
            ...
            <div class="row js--wp-3">
                    <div class="col span-1-of-4 box">
                        <img src="resources/img/lisbon-3.jpg" alt="Losbon city" class="city-photo">
                        <h3>Lisbon</h3>
                    ...
                    <div class="col span-1-of-4 box">
                        <img src="resources/img/san-francisco.jpg" alt="San Francisco city">
                        <h3>San Francisco</h3>
                        <div class="city-features">
                            <ion-icon name="person" class="icon-small"></ion-icon>
                            3700+ happy eaters
                    ...
                    <div class="col span-1-of-4 box">
                        <img src="resources/img/berlin.jpg" alt="Berlin city">
                        <h3>Berlin</h3>
                        <div class="city-features">
                            <ion-icon name="person" class="icon-small"></ion-icon>
                            2300+ happy eaters
                    ...
                    <div class="col span-1-of-4 box">
                        <img src="resources/img/london.jpg" alt="London city">
                        <h3>London</h3>
                        <div class="city-features">
                            <ion-icon name="person" class="icon-small"></ion-icon>
                            1200+ happy eaters
            ...
            <div class="row">
                <div class="col span-1-of-3">
                    <blockquote>
                        ...
                        <cite><img src="resources/img/customer-1.jpg" alt="Costumer 1"> Alberto Duncan</cite>
                    </blockquote>
                </div>
                <div class="col span-1-of-3">
                    <blockquote>
                        Inexpensive, healthy and great-tasting meals, delivered right to my home. We have lots of food delivery here in Lisbon, but no one comes even close to Omifood. Me and my family are so in love!
                        <cite><img src="resources/img/customer-2.jpg" alt="Costumer 2">Joana Silva</cite>
                    </blockquote>
                </div>
                <div class="col span-1-of-3">
                    <blockquote>I was looking for a quick and easy food delivery service in San Franciso. I tried a lot of them and ended up with Omnifood. Best food delivery service in the Bay Area. Keep up the great work!
                        <cite><img src="resources/img/customer-3.jpg" alt="Costumer 3">Milton Chapman</cite>
                    </blockquote>
                </div>
            </div>
        </section>
        ...
        <footer>
            <div class="row">
                ...
                <div class="col span-1-of-2">
                    <ul class="social-links">
                        ...
                        <li><a href="#"><ion-icon name="logo-googleplus" class="google-icon"></ion-icon></a></li>
            ...
            <div class="row">
                <p>
                    Copyright &copy; 2019 by Omnifood. All rigths reserved.
                </p>
            </div>
        </footer>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-143865478-2"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());

      gtag('config', 'UA-143865478-2');
    </script>
